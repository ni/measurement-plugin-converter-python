...
def convert_measurement(
    ...
    output_variable_names, output_variable_types = get_return_details(
        existing_measurement_path, method_name
    )
    ...
    session_details = replace_session_initialization(
        migrated_measurement_path, method_name, _drivers
    )
    ...
    insert_session_assigning(
        migrated_measurement_path, method_name, actual_session_name + " = session_info.session"
    )
