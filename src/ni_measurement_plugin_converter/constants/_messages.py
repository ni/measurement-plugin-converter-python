...
class UserMessage:
    ...
    INVALID_FILE_DIR = "Invalid measurement file directory. Please provide valid measurement file directory."
    ACCESS_DENIED = "Access is denied. Please run the tool with Admin privileges or provide a different file directory."
    ...
    ADD_RESERVE_SESSION = "Adding reserve session..."
