...
LABEL = (
    '<Label Height="[float]16" Id="{id}" LabelOwner="[UIModel]{shared_id}" '
    'Left="[float]{left_value}" Text="[string]{input_output_name}" Top="[float]{top_value}" '
    'Width="[float]100" xmlns="http://www.ni.com/PanelCommon" />'
)
