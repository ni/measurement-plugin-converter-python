...
- The tool supports converting only one measurement plug-in in a single execution.
...
- The `measurement.py` file in the generated plug-in is not formatted using [black](https://pypi.org/project/black/).
